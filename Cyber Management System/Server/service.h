...
void add_services()
{
    ...
    service1.item_id = temp_id;
    fflush(stdin);
    gotoxy(leftpos + 13, 18);
    gets(service1.item_name);
    gotoxy(leftpos + 13, 21);
    scanf("%d", &service1.item_price);
    gotoxy(leftpos + 13, 24);
...
void view_services()
{
    ...
    gotoxy(leftpos1 + 10, 15);
    printf("Item ID");
    gotoxy(leftpos1 + 20, 15);
    printf("Item Name");
    gotoxy(leftpos1 + 40, 15);
    printf("Price");
    gotoxy(leftpos1 + 60, 15);
    printf("Quantity");
    while (fread(&service1, sizeof(service1), 1, fp) == 1)
    {
        gotoxy(leftpos1 + 10, 18 + i);
        printf("%d", service1.item_id);
        gotoxy(leftpos1 + 20, 18 + i);
        printf("%s", service1.item_name);
        gotoxy(leftpos1 + 40, 18 + i);
        printf("%d", service1.item_price);
        gotoxy(leftpos1 + 60, 18 + i);
    ...
    case '1':
    {
        ...
        while (fread(&service1, sizeof(service1), 1, fp) == 1)
        {
            if (temp_id == service1.item_id)
            {
                ...
                gotoxy(leftpos + 2, 22);
                printf("Item Name: %s", service1.item_name);
                gotoxy(leftpos + 2, 25);
                printf("Item Price: Rs. %d", service1.item_price);
                gotoxy(leftpos + 2, 28);
                printf("Quantity: %d", service1.item_qty);
            }
        }
    }
        if (flag == 0)
